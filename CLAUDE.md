...
(`system.json`: id `starwarsffg`, version `2.1.39`, compatibility minimum 13 /
...
or the launcher starts warning that the system is unverified. This is a maintained fork
